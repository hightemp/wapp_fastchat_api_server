...
# args.model_name = "/home/hightemp/ForTesting/FastChat/vicuna_7b/"
# args.device = "cpu"
...
async def read_index():
    return FileResponse("static/client/dist/index.html")
...
def predict(text_request: TextRequest):
    ...
    while True:
        ...
        return TextResponse(result=[" ".join(outputs)])
